object dm: Tdm
  ...
  object DsSaidaProduto: TDataSource
  ...
  object tb_pagaFun: TFDTable
    Connection = fd
    UpdateOptions.UpdateTableName = 'pdv.pagamento_funcionario'
    TableName = 'pdv.pagamento_funcionario'
    Left = 976
    Top = 88
  end
  object query_pagafun: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from pagamento_funcionario')
    Left = 976
    Top = 152
    object query_pagafunid: TFDAutoIncField
      FieldName = 'id'
      Origin = 'id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    ...
    object query_pagafunmotivo: TStringField
      DisplayLabel = 'Motivo'
      DisplayWidth = 10
      FieldName = 'motivo'
      Origin = 'motivo'
    ...
    object query_pagafunvalor: TBCDField
      DisplayLabel = 'Valor'
      DisplayWidth = 10
      FieldName = 'valor'
      Origin = 'valor'
    ...
    object query_pagafunfuncionario: TStringField
      DisplayLabel = 'Funcion'#225'rio'
      DisplayWidth = 20
      FieldName = 'funcionario'
      Origin = 'funcionario'
    ...
    object query_pagafundata: TDateField
      DisplayLabel = 'Data'
      FieldName = 'data'
      Origin = 'data'
      Required = True
  ...
  object DSPagaFun: TDataSource
    DataSet = query_pagafun
    Left = 976
    Top = 216
  end
  object rel_comprovante: TfrxReport
    ...
    ReportOptions.LastChange = 44044.810470960650000000
    ...
    object Page1: TfrxReportPage
      ...
      object Header1: TfrxHeader
        ...
        object Memo2: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'RUA PROF HOMERO 4500 - PINDAMONHANGABA - SP - 12425-250')
          ParentFont = False
        end
        object Memo3: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'CNPJ 00.000.000/0001-00          IE 01111111111')
          ParentFont = False
        end
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo27: TfrxMemoView
          ...
          Frame.Typ = []
          Memo.UTF8W = (
            'DESENVOLVIDO POR MATHEUS AUGUSTO - CURSO')
          ParentFont = False
        end
      end
    end
  ...
  object query_caixa: TFDQuery
    ...
    object query_caixaoperador: TStringField
      DisplayLabel = 'Operador do Caixa'
      DisplayWidth = 20
      FieldName = 'operador'
      Origin = 'operador'
      Required = True
  ...
  object rel_movimentacoes: TfrxReport
    ...
    ReportOptions.LastChange = 44033.862925173610000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
      ...
      object PageFooter1: TfrxPageFooter
        ...
        object Memo16: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Rua Professor Homero de Mello Oliveira 600 - Pindamonhangaba - S' +
              'P')
          ParentFont = False
        end
        object Memo5: TfrxMemoView
  ...
  object rel_produtos: TfrxReport
    ...
    ReportOptions.LastChange = 44033.863852175930000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
  ...
  object rel_caixa: TfrxReport
    ...
    ReportOptions.LastChange = 44044.810636030100000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
  ...
  object query_caixa_inicio: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from caixa')
    Left = 1136
    Top = 152
    object query_caixa_inicioid: TFDAutoIncField
      FieldName = 'id'
      Origin = 'id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    ...
    object query_caixa_iniciodata_abertura: TDateField
    ...
    object query_caixa_iniciohora_abertura: TTimeField
    ...
    object query_caixa_iniciovalor_abertura: TBCDField
    ...
    object query_caixa_iniciofuncionario_abertura: TStringField
    ...
    object query_caixa_iniciodata_fechamento: TDateField
      AutoGenerateValue = arDefault
      FieldName = 'data_fechamento'
      Origin = 'data_fechamento'
      Visible = False
    end
    object query_caixa_iniciohora_fechamento: TTimeField
      AutoGenerateValue = arDefault
      FieldName = 'hora_fechamento'
      Origin = 'hora_fechamento'
      Visible = False
    end
    object query_caixa_iniciovalor_fechamento: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'valor_fechamento'
      Origin = 'valor_fechamento'
      Visible = False
    ...
    object query_caixa_iniciovalor_vendido: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'valor_vendido'
      Origin = 'valor_vendido'
      Visible = False
    ...
    object query_caixa_iniciovalor_quebra: TBCDField
      AutoGenerateValue = arDefault
      FieldName = 'valor_quebra'
      Origin = 'valor_quebra'
      Visible = False
    ...
    object query_caixa_iniciofuncionario_fechamento: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'funcionario_fechamento'
      Origin = 'funcionario_fechamento'
      Visible = False
    ...
    object query_caixa_inicionum_caixa: TIntegerField
      DisplayLabel = 'Caixa'
      FieldName = 'num_caixa'
      Origin = 'num_caixa'
      Required = True
    end
    object query_caixa_iniciooperador: TStringField
    ...
    object query_caixa_iniciostatus: TStringField
      DisplayLabel = 'Status'
      DisplayWidth = 12
      FieldName = 'status'
      Origin = 'status'
  ...
  object DsCaixaInicio: TDataSource
    DataSet = query_caixa_inicio
    Left = 1136
    Top = 216
  end
  object rel_vendas: TfrxReport
    ...
    ReportOptions.LastChange = 43651.829072893500000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
  ...
  object query_coringa_vendas: TFDQuery
    Connection = fd
    SQL.Strings = (
      'select * from vendas where data = curDate() order by id desc ')
    Left = 1256
    Top = 168
  ...
  object DSVendaInicio: TDataSource
